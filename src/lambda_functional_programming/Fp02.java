...
public class Fp02 {
    /*
    1) t-> "Logic" , (t, u)-> "Logic"
       Bu yapıya "Lambda Expession" denir.
    ...
    3) "Method Reference" kullanımı "Class Name :: Method Name" şeklindedir.

       Aynı zamanda kendi classlarınızı da kullanabilirsiniz.
       Örneğin bir Animal classınız var ve bu class "eat()" methoduna sahip. ==> "Animal :: eat"
